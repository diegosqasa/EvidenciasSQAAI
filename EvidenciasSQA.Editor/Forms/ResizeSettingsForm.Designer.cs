...
namespace EvidenciasSQA.Editor.Forms {
	partial class ResizeSettingsForm {
		...
		private void InitializeComponent() {
			...
			this.checkbox_aspectratio = new EvidenciasSQACheckBox();
			this.label_width = new EvidenciasSQALabel();
			this.label_height = new EvidenciasSQALabel();
		...
		private EvidenciasSQACheckBox checkbox_aspectratio;
		private EvidenciasSQALabel label_width;
		private EvidenciasSQALabel label_height;
