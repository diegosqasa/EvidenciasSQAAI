...
using EvidenciasSQA.Editor.Drawing.Fields.Binding;
using EvidenciasSQA.Editor.Helpers;
using log4net;

namespace EvidenciasSQA.Editor.Forms
{
    /// <summary>
    /// The ImageEditorForm is the editor for EvidenciasSQA
    /// </summary>
    public partial class ImageEditorForm : EditorForm, IImageEditor
    {
        ...
        private EvidenciasSQAToolStripButton[] _toolbarButtons;
        ...
        private void Initialize(ISurface surface, bool outputMade)
        {
            ...
            // to just the bare form language key ("EvidenciasSQA editor").
        ...
        private void SetSurface(ISurface newSurface)
        {
            ...
            Image backgroundForTransparency = EvidenciasSQAResources.GetImage("Checkerboard.Image");
            if (_surface != null)
            {
        ...
        /**
         * Interfaces for plugins, see EvidenciasSQAInterface for more details!
         */
        ...
        private void UncheckAllToolButtons()
        {
            ...
            {
                foreach (EvidenciasSQAToolStripButton butt in _toolbarButtons)
                {
                    butt.Checked = false;
                }
            }
        ...
        private void SaveElementsToolStripMenuItemClick(object sender, EventArgs e)
        {
            ...
            {
                Filter = "EvidenciasSQA templates (*.gst)|*.gst",
        ...
        public bool TrySaveState(string filePath)
        {
            ...
            try
            {
                ImageIO.Save(_surface, filePath, true, new SurfaceOutputSettings(OutputFormat.evidenciassqa), false);
