...
namespace EvidenciasSQA.Editor.Forms {
	partial class TornEdgeSettingsForm {
		...
		private void InitializeComponent() {
			...
			this.buttonOK = new EvidenciasSQAButton();
			this.buttonCancel = new EvidenciasSQAButton();
			this.labelDarkness = new EvidenciasSQALabel();
			this.labelOffset = new EvidenciasSQALabel();
			this.labelThickness = new EvidenciasSQALabel();
			this.toothsize = new System.Windows.Forms.NumericUpDown();
			this.label_toothsize = new EvidenciasSQALabel();
			this.label_horizontaltoothrange = new EvidenciasSQALabel();
			this.horizontaltoothrange = new System.Windows.Forms.NumericUpDown();
			this.labelVerticaltoothrange = new EvidenciasSQALabel();
			this.verticaltoothrange = new System.Windows.Forms.NumericUpDown();
			this.top = new EvidenciasSQACheckBox();
			this.right = new EvidenciasSQACheckBox();
			this.bottom = new EvidenciasSQACheckBox();
			this.left = new EvidenciasSQACheckBox();
			this.shadowCheckbox = new EvidenciasSQACheckBox();
			this.all = new EvidenciasSQACheckBox();
		...
		private EvidenciasSQAButton buttonOK;
		private EvidenciasSQAButton buttonCancel;
		private EvidenciasSQALabel labelDarkness;
		private EvidenciasSQALabel labelOffset;
		private EvidenciasSQALabel labelThickness;
		private System.Windows.Forms.NumericUpDown toothsize;
		private EvidenciasSQALabel label_toothsize;
		private EvidenciasSQALabel label_horizontaltoothrange;
		private System.Windows.Forms.NumericUpDown horizontaltoothrange;
		private EvidenciasSQALabel labelVerticaltoothrange;
		private System.Windows.Forms.NumericUpDown verticaltoothrange;
		private EvidenciasSQACheckBox top;
		private EvidenciasSQACheckBox right;
		private EvidenciasSQACheckBox bottom;
		private EvidenciasSQACheckBox left;
		private EvidenciasSQACheckBox shadowCheckbox;
        private EvidenciasSQACheckBox all;
	}
}