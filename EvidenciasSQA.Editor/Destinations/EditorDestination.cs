...
namespace EvidenciasSQA.Editor.Destinations
{
    /// <summary>
    ...
    public class EditorDestination : AbstractDestination
    {
        ...
        private static readonly Image evidenciassqaIcon = EvidenciasSQAResources.GetEvidenciasSQAIcon().ToBitmap();
        ...
        public override Image DisplayIcon => evidenciassqaIcon;
