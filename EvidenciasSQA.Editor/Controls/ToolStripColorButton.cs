...
using ColorDialog = EvidenciasSQA.Editor.Forms.ColorDialog;

namespace EvidenciasSQA.Editor.Controls
{
    public class ToolStripColorButton : ToolStripButton, INotifyPropertyChanged, IEvidenciasSQALanguageBindable
    {
