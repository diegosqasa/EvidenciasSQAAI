...
using EvidenciasSQA.Editor.Memento;

namespace EvidenciasSQA.Editor.Drawing
{
    /// <summary>
    ...
    public class TextContainer : RectangleContainer, ITextContainer
    {
        ...
        private void UpdateTextBoxFont()
        {
            ...
            // with fonts deserialized from old .evidenciassqa files whose FONT_SIZE field
            ...
            try
            {
                ...
                // (e.g. faces no longer installed, or invalid metrics from old .evidenciassqa files).
