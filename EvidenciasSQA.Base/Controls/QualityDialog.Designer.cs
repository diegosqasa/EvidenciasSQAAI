...
namespace EvidenciasSQA.Base.Controls {
	partial class QualityDialog {
		...
		{
			this.label_choosejpegquality = new EvidenciasSQALabel();
			...
			this.checkBox_reduceColors = new EvidenciasSQACheckBox();
		...
		private EvidenciasSQALabel label_choosejpegquality;
		private EvidenciasSQACheckBox checkBox_reduceColors;
	}
}
