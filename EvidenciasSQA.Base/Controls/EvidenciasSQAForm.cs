...
namespace EvidenciasSQA.Base.Controls
{
    ...
    /// </summary>
    public class EvidenciasSQAForm : Form, IEvidenciasSQALanguageBindable
    {
        private static readonly ILog LOG = LogManager.GetLogger(typeof(EvidenciasSQAForm));
        ...
        protected void InitializeForDesigner()
        {
            ...
            try
            {
                ...
                // Language.AddLanguageFilePath(@"C:\EvidenciasSQA\EvidenciasSQA\Languages");
                ...
                if (assemblyDirectory != null && !Language.AddLanguageFilePath(Path.Combine(assemblyDirectory, @"..\..\EvidenciasSQA\Languages\")))
                {
                    Language.AddLanguageFilePath(Path.Combine(assemblyDirectory, @"..\..\..\EvidenciasSQA\Languages\"));
                }
        ...
        {
            // Every EvidenciasSQAForm should have it's default icon
        ...
        /// <summary>
        /// check if the form was closed with an OK, if so store the values in the EvidenciasSQAControls
        /// </summary>
        /// <param name="e"></param>
        ...
        protected void ApplyLanguage(ToolStripItem applyTo, string languageKey)
        {
            ...
            else
            {
                ...
                if (!DesignMode)
                {
                    LOG.DebugFormat("EvidenciasSQA control without language key: {0}", applyTo.Name);
                }
            }
        }
        ...
        {
            if (applyTo is IEvidenciasSQALanguageBindable languageBindable)
            {
        ...
        {
            if (applyTo is not IEvidenciasSQALanguageBindable languageBindable)
            {
            ...
            if (applyTo is not (IEvidenciasSQAConfigBindable configBindable and EvidenciasSQAComboBox comboxBox)) return;
        ...
        /// <summary>
        /// Apply all the language settings to the "EvidenciasSQA" Controls on this form
        /// </summary>
        protected void ApplyLanguage()
        {
            ...
            try
            {
                ...
                // Reset the text values for all EvidenciasSQAControls
        ...
        /// <summary>
        /// Fill all EvidenciasSQAControls with the values from the configuration
        /// </summary>
        private void FillFields()
        {
            foreach (FieldInfo field in GetCachedFields(GetType()))
            {
                ...
                IEvidenciasSQAConfigBindable configBindable = controlObject as IEvidenciasSQAConfigBindable;
                ...
                if (controlObject is EvidenciasSQAComboBox comboxBox)
                {
        ...
        /// <summary>
        /// Store all EvidenciasSQAControl values to the configuration
        /// </summary>
