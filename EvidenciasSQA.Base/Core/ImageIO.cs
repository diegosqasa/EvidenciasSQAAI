...
namespace EvidenciasSQA.Base.Core
{
    ...
    public static class ImageIO
    {
        ...
        /// <param name="surface">surface for the elements, needed if the evidenciassqa format is used</param>
        /// <param name="stream">Stream to save to</param>
        /// <param name="outputSettings">SurfaceOutputSettings</param>
        public static void SaveToStream(Image imageToSave, ISurface surface, Stream stream, SurfaceOutputSettings outputSettings)
        {
            ...
            if (outputSettings.Format == OutputFormat.evidenciassqa && surface == null)
            {
                throw new ArgumentException("Surface needs to be set when using OutputFormat.EvidenciasSQA");
            }
        ...
        public static bool CreateImageFromSurface(ISurface surface, SurfaceOutputSettings outputSettings, out Image imageToSave)
        {
            ...
            if (outputSettings.Format == OutputFormat.evidenciassqa || outputSettings.SaveBackgroundOnly)
            {
            ...
            // The following block of modifications should be skipped when saving the evidenciassqa format, no effects or otherwise!
            if (outputSettings.Format == OutputFormat.evidenciassqa)
            {
                return disposeImage;
            }
        ...
        /// <summary>
        /// Add the evidenciassqa property!
        /// </summary>
        /// <param name="imageToSave"></param>
        public static void AddTag(this Image imageToSave)
        {
            // Create meta-data
            PropertyItem softwareUsedPropertyItem = CreatePropertyItem(PROPERTY_TAG_SOFTWARE_USED, "EvidenciasSQA");
        ...
        /// <summary>
        /// Load a EvidenciasSQA surface
        /// </summary>
        /// <param name="fullPath"></param>
        /// <param name="returnSurface"></param>
        /// <returns></returns>
        public static ISurface LoadEvidenciasSQASurface(string fullPath, ISurface returnSurface)
        {
            ...
            {
                returnSurface = LoadEvidenciasSQASurface(surfaceFileStream, returnSurface);
            }
        ...
        public static string SaveNamedTmpFile(Image renderedImage, ICaptureDetails captureDetails, SurfaceOutputSettings outputSettings)
        {
            ...
            {
                pattern = "evidenciassqa ${capturetime}";
            }
        ...
        /// <summary>
        /// Load a EvidenciasSQA surface from a stream
        /// </summary>
        /// <param name="surfaceFileStream">Stream</param>
        /// <param name="returnSurface"></param>
        /// <returns>ISurface</returns>
        public static ISurface LoadEvidenciasSQASurface(Stream surfaceFileStream, ISurface returnSurface)
        {
            Image fileImage;
            ...
            {
                Log.DebugFormat("Loaded .evidenciassqa file with Size {0}x{1} and PixelFormat {2}", tmpImage.Width, tmpImage.Height, tmpImage.PixelFormat);
            ...
            if (fileImage != null)
            {
                ...
                Log.InfoFormat("Information about .evidenciassqa file: {0}x{1}-{2} Resolution {3}x{4}", fileImage.Width, fileImage.Height, fileImage.PixelFormat,
                    fileImage.HorizontalResolution, fileImage.VerticalResolution);
            }
