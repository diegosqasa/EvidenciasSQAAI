...
namespace EvidenciasSQA.Base.Core.OAuth
{
    /// <summary>
    ...
    public class OAuthSession
    {
        ...
        private string _userAgent = "EvidenciasSQA";
        ...
        public string CallbackUrl { get; set; } = "https://evidenciassqa.com";

        public bool CheckVerifier { get; set; } = true;

        public Size BrowserSize { get; set; } = new Size(864, 587);

        public string LoginTitle { get; set; } = "Authorize EvidenciasSQA access";
