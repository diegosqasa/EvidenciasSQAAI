...
{
    /// <summary>
    /// Holds runtime environment state for EvidenciasSQA that is determined at startup
    /// and shared across the application.
    /// </summary>
    public static class EvidenciasSQAEnvironment
    {
        /// <summary>
        /// Gets a value indicating whether EvidenciasSQA is running in PortableApp (PAF) mode.
        /// Set to <c>true</c> when the standard PortableApp directory structure
        /// (<c>App\EvidenciasSQA</c> next to the executable) is detected at startup.
        /// </summary>
        public static bool IsPortable { get; set; }

        /// <summary>
        /// Gets the full path of the active <c>evidenciassqa.ini</c> configuration file.
