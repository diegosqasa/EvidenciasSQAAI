...
namespace EvidenciasSQA.Base.Core
{
    ...
    public class LogHelper
    {
        ...
        private const string InitMessage = "EvidenciasSQA initialization of log system failed";
        ...
        public static string InitializeLog4Net()
        {
            ...
            {
                "log4net.xml", @"App\EvidenciasSQA\log4net-portable.xml"
            })
            {
            ...
            if (!_isLog4NetConfigured)
            {
                try
                {
                    ...
                    using Stream stream = assembly.GetManifestResourceStream("EvidenciasSQAPlugin.log4net-embedded.xml");
