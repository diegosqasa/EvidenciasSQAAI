...
{
    /// <summary>
    /// Registers all custom Dapplo.Ini value converters required by EvidenciasSQA's
    ...
    public static class IniValueConverters
    {
        ...
        /// <summary>
        /// Registers all EvidenciasSQA-specific value converters with
    ...
    /// format is identical to what the old EvidenciasSQA code produced (named colours such
