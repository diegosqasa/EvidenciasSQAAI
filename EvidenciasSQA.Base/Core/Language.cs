...
namespace EvidenciasSQA.Base.Core
{
    ...
    public class Language
    {
        ...
        static Language()
        {
            if (!IniConfigRegistry.TryGet("evidenciassqa.ini", out _))
            {
                ...
                IniConfigRegistry.ForFile("evidenciassqa.ini")
            ...
            try
            {
                ...
                {
                    AddPath(Path.Combine(applicationFolder, @"App\EvidenciasSQA\Languages"));
                }

                // Application data path
                string applicationDataFolder = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData);
                AddPath(Path.Combine(applicationDataFolder, @"EvidenciasSQA\Languages\"));
