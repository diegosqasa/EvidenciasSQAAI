...
namespace EvidenciasSQA.Base.Interfaces
{
    /// <summary>
    ...
    public interface IFileFormatHandler
    {
        ...
        /// <param name="surface">ISurface with the elements for those file types which can store a surface (.evidenciassqa)</param>
