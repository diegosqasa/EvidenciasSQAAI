...
{
    /// <summary>
    /// This interface is the EvidenciasSQAPluginHost, that which "Hosts" the plugin.
    /// For EvidenciasSQA this is implemented in the PluginHelper
    /// </summary>
    public interface IEvidenciasSQAHost
    {
        /// <summary>
        /// Create a Thumbnail
        /// </summary>
