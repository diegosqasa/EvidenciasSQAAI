...
namespace EvidenciasSQA.Base.Interfaces.Plugin
{
    public class SurfaceOutputSettings
    {
        ...
        /// <summary>
        /// BUG-2056 reported a logical issue, using evidenciassqa format as the default causes issues with the external commands.
        /// </summary>
        /// <returns>this for fluent API usage</returns>
        public SurfaceOutputSettings PreventEvidenciasSQAFormat()
        {
            // If OutputFormat is EvidenciasSQA, use PNG instead.
