...
namespace EvidenciasSQA.Forms
{
	partial class PrintOptionsDialog
	{
		...
		{
			this.checkbox_dontaskagain = new EvidenciasSQACheckBox();
			this.checkboxAllowShrink = new EvidenciasSQACheckBox();
			this.checkboxAllowEnlarge = new EvidenciasSQACheckBox();
			this.checkboxAllowCenter = new EvidenciasSQACheckBox();
			this.checkboxAllowRotate = new EvidenciasSQACheckBox();
			this.button_ok = new EvidenciasSQAButton();
			this.checkboxDateTime = new EvidenciasSQACheckBox();
			this.button_cancel = new EvidenciasSQAButton();
			this.checkboxPrintInverted = new EvidenciasSQACheckBox();
			this.radioBtnGrayScale = new EvidenciasSQARadioButton();
			this.radioBtnMonochrome = new EvidenciasSQARadioButton();
			this.groupBoxPrintLayout = new EvidenciasSQAGroupBox();
			this.groupBoxColors = new EvidenciasSQAGroupBox();
			this.radioBtnColorPrint = new EvidenciasSQARadioButton();
			...
			this.Text = "EvidenciasSQA print options";
		...
		private EvidenciasSQARadioButton radioBtnGrayScale;
		private EvidenciasSQACheckBox checkboxPrintInverted;
		private EvidenciasSQAButton button_cancel;
		private EvidenciasSQACheckBox checkboxDateTime;
		private EvidenciasSQAButton button_ok;
		private EvidenciasSQACheckBox checkboxAllowRotate;
		private EvidenciasSQACheckBox checkboxAllowCenter;
		private EvidenciasSQACheckBox checkboxAllowEnlarge;
		private EvidenciasSQACheckBox checkboxAllowShrink;
		private EvidenciasSQACheckBox checkbox_dontaskagain;
        private EvidenciasSQARadioButton radioBtnMonochrome;
        private EvidenciasSQAGroupBox groupBoxPrintLayout;
        private EvidenciasSQAGroupBox groupBoxColors;
        private EvidenciasSQARadioButton radioBtnColorPrint;
	}
}
