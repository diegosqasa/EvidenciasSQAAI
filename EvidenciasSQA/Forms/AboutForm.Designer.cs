...
namespace EvidenciasSQA.Forms {
	partial class AboutForm {
		...
		private void InitializeComponent() {
			...
			this.lblLicense = new EvidenciasSQALabel();
			this.lblHost = new EvidenciasSQALabel();
			...
			this.lblBugs = new EvidenciasSQALabel();
			this.linkLblDonations = new System.Windows.Forms.LinkLabel();
			this.lblDonations = new EvidenciasSQALabel();
			this.linkLblIcons = new System.Windows.Forms.LinkLabel();
			this.lblIcons = new EvidenciasSQALabel();
			this.linkLabel1 = new System.Windows.Forms.LinkLabel();
			this.pictureBox1 = new System.Windows.Forms.PictureBox();
			this.lblTranslation = new EvidenciasSQALabel();
			...
			this.lblTitle.Text = "EvidenciasSQA x.x.xxx";
			// 
			// lblLicense
			// 
			...
			this.linkLblHost.Text = "https://github.com/evidenciassqa/evidenciassqa";
			...
			this.linkLblBugs.Text = "https://evidenciassqa.com/tickets";
            this.linkLblBugs.Tag = "https://evidenciassqa.com/tickets/?version=" + EnvironmentInfo.GetEvidenciasSQAVersion(true);
			...
			this.linkLblDonations.Text = "https://evidenciassqa.com/support";
            this.linkLblDonations.Tag = "https://evidenciassqa.com/support/?version=" + EnvironmentInfo.GetEvidenciasSQAVersion(true);
			...
			this.linkLabel1.Text = "https://evidenciassqa.com";
			this.linkLabel1.TextAlign = System.Drawing.ContentAlignment.TopLeft;
            this.linkLabel1.Tag = "https://evidenciassqa.com/?version=" + EnvironmentInfo.GetEvidenciasSQAVersion(true);
		...
		private EvidenciasSQALabel lblTranslation;
		private EvidenciasSQALabel lblHost;
		private EvidenciasSQALabel lblDonations;
		private EvidenciasSQALabel lblBugs;
		private EvidenciasSQALabel lblIcons;
		private EvidenciasSQALabel lblLicense;
	}
}
