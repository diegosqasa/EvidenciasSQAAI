    ...
    public sealed partial class SharingForm : BaseForm
    {
        ...
        private async void OnDataRequested(DataTransferManager sender, DataRequestedEventArgs args)
        {
            ...
            try
            {
                ...
                // Capture itself
                string uniqueFileName = $"evidenciassqa_share_{shareGuid}.png";
                ...
                dataPackage.Properties.ApplicationName = "EvidenciasSQA";
        ...
        private void CleanupOldShareFiles()
        {
            try
            {
                ...
                string[] oldFiles = Directory.GetFiles(tempDir, "evidenciassqa_share_*.png");
