...
namespace EvidenciasSQA.Plugin.Win10
{
    /// <summary>
    ...
    public class ToastNotificationService : INotificationService
    {
        ...
        public ToastNotificationService()
        {
            ...
            {
                Log.Info("EvidenciasSQA was activated due to a toast.");
            }
            ...
            var localAppData = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "EvidenciasSQA");
            if (!Directory.Exists(localAppData))
            {
                Directory.CreateDirectory(localAppData);
            }

            _imageFilePath = Path.Combine(localAppData, "evidenciassqa.png");
            ...
            using var evidenciassqaImage = EvidenciasSQAResources.GetEvidenciasSQAIcon().ToBitmap();
            evidenciassqaImage.Save(_imageFilePath, ImageFormat.Png);
        }
