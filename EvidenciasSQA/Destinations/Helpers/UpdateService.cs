...
using EvidenciasSQA.Helpers.Entities;
using log4net;
...
namespace EvidenciasSQA.Helpers
{
    ...
    public class UpdateService
    {
        ...
        private static readonly Uri UpdateFeed = new Uri("https://evidenciassqa.com/update-feed.json");
        private static readonly Uri Downloads = new Uri("https://evidenciassqa.com/downloads");
