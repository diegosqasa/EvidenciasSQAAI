...
namespace EvidenciasSQA.Helpers
{
    ...
    public static class StartupHelper
    {
        ...
        private const string ApplicationName = "EvidenciasSQA";
        ...
        /// </summary>
        /// <returns>true if EvidenciasSQA can write key</returns>
        ...
        /// <summary>
        /// Return true if the local machine has a RUN entry for EvidenciasSQA
        /// </summary>
        ...
        /// <summary>
        /// Return true if the current user has a RUN entry for EvidenciasSQA
        /// </summary>
        /// <returns>true if there is a run key</returns>
