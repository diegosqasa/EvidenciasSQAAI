...
// printing help text, because EvidenciasSQA is built as a WinExe and has no console by default.
using Dapplo.Windows.Kernel32;

namespace EvidenciasSQA.Helpers
{
    /// <summary>
    /// Holds the result of parsing EvidenciasSQA's command line arguments.
    /// </summary>
    public class CommandLineOptions
    {
        /// <summary>
        /// When true, send an exit command to all running EvidenciasSQA instances and exit.
        /// </summary>
        public bool Exit { get; set; }

        /// <summary>
        /// When true, send a reload-configuration command to all running EvidenciasSQA instances and exit.
        /// </summary>
        ...
        /// <summary>
        /// When set, use this directory for reading and writing the evidenciassqa.ini configuration file.
        /// </summary>
        public string IniDirectory { get; set; }

        /// <summary>
        /// One or more image files to open in the running EvidenciasSQA instance,
    ...
    /// <summary>
    /// Defines and parses EvidenciasSQA's command line interface using System.CommandLine.
    ...
    /// </summary>
    internal static class EvidenciasSQACommandLine
    {
        private static readonly Option<bool> ExitOption = new Option<bool>("--exit")
        {
            Description = "Send an exit command to all running EvidenciasSQA instances."
        };

        private static readonly Option<bool> ReloadOption = new Option<bool>("--reload")
        {
            Description = "Send a reload-configuration command to all running EvidenciasSQA instances."
        };

        private static readonly Option<bool> NoRunOption = new Option<bool>("--no-run")
        {
            Description = "Exit immediately without starting or showing EvidenciasSQA."
        };

        private static readonly Option<string> LanguageOption = new Option<string>("--language")
        {
            HelpName = "language-code",
            Description = "Set the UI language for EvidenciasSQA (e.g. en-US, de-DE) and save the configuration."
        };

        private static readonly Option<string> IniDirectoryOption = new Option<string>("--ini-directory")
        {
            HelpName = "directory",
            Description = "Set the directory where evidenciassqa.ini is stored and read."
        };
        ...
        private static readonly Argument<string[]> FilesArgument = new Argument<string[]>("files")
        {
            ...
            Description = "One or more image files to open. If EvidenciasSQA is already running, the files are opened in the existing instance."
        };
        ...
        public static CommandLineOptions Parse(string[] args)
        {
            ...
            // EvidenciasSQA is a WinExe and has no console window by default.
        ...
        {
            var rootCommand = new RootCommand("EvidenciasSQA")
            {
                Description = "EvidenciasSQA is a free and open source screenshot tool for Windows.\n\n" +
                                 "Note: When another EvidenciasSQA instance is already running, commands such as\n" +
                                 ...
                                 "instance. If no other instance is running, EvidenciasSQA starts normally."
            };
