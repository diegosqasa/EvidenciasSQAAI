...
namespace EvidenciasSQA.Destinations
{
    ...
    {
        private static readonly Image MailIcon = EvidenciasSQAResources.GetImage("Email.Image");
        ...
        public override bool IsActive
        {
            get
            {
                if (_isActiveFlag)
                {
                    ...
                    var outlookDestination = Type.GetType("EvidenciasSQA.Plugin.Office.Destinations.OutlookDestination,EvidenciasSQA.Plugin.Office", false);
